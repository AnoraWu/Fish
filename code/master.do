...
do "code/prep/RAM_cleaning.do"
	...
	* Input: RAM Geography/results/ram.shp, RAM Geography/sources/latlon.csv,
	...
	*/
shell $pythonpath "code/prep/RAM_overlaps.py"
...
do "code/prep/RAM_overlaps.do"
	...
	*/
rscript using "code/FAO Predictions/FAO_Predictions.R"
