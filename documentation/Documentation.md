### Note: This replication package is not complete. This document only lists code files in MPA-Fish-Effects-Replication folder that have been checked by Anora Wu (wwu54@jh.edu) 
### Future Change: Per Michael's suggestion, the protection cells should be made contiguous in the simulations.
